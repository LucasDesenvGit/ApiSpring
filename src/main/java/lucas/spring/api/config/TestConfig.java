package lucas.spring.api.config;

import lucas.spring.api.entities.*;
import lucas.spring.api.entities.enums.OrderStatus;
import lucas.spring.api.repositories.*;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2025-06-20T15:50:50Z"), o1);
        o1.setPayment(pay1);
